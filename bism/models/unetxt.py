...
from ..modules.convnext_block import Block2D, Block3D
from ..modules.layer_norm import LayerNorm
from ..modules.concat import ConcatConv2D, ConcatConv3D
from ..modules.upsample_layer import UpSampleLayer3D, UpSampleLayer2D
...
class UNeXT_2D(nn.Module):
    def __init__(self, in_channels: Optional[int] = 1,
        ...
        # ----------------- Stage 1
        self.init_stage = nn.Sequential(
            nn.Conv2d(in_channels, dims[0], kernel_size=7, padding=3),
            Block(dim=dims[0], drop_path=0.0, kernel_size=kernel_size, activation=activation)
        )
